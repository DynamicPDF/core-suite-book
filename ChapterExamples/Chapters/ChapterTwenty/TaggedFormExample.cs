...
{
    public class TaggedFormExample
    {
        ...
        public static void Create(string outputPath)
        {
            ...
            doc.Draw(outputPath + "tagged-form-out.pdf");
        ...
        public static void AddTextField(Document doc)
        {
            ...
            textField.ToolTip = "Enter favorite color as text.";
            textField.BorderStyle = BorderStyle.Solid;
            doc.Pages[0].Elements.Add(label);
            doc.Pages[0].Elements.Add(textField);
        }
        ...
        public static void AddButtons(Document doc)
        {
            ...
            button.Action = new SubmitAction("nowhere", FormExportFormat.HtmlGet);
            button.Label = "Submit";
            button.ToolTip = "Submit button.";
